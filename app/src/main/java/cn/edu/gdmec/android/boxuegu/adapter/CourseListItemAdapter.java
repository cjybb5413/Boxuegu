...
public class CourseListItemAdapter extends RecyclerView.Adapter<CourseListItemAdapter.ViewHolder>{
    ...
    private void initializeViews(final CourseBean object, ViewHolder holder) {
        ...
        if (object != null){
            ...
            switch (object.id){
                case 1:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_1_icon);
                    break;
                case 2:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_2_icon);
                    break;
                case 3:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_3_icon);
                    break;
                case 4:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_4_icon);
                    break;
                case 5:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_5_icon);
                    break;
                case 6:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_6_icon);
                    break;
                case 7:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_7_icon);
                    break;
                case 8:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_8_icon);
                    break;
                case 9:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_9_icon);
                    break;
                case 10:
                    holder.ivCoursrImg.setImageResource(R.drawable.chapter_10_icon);
                    break;
            }
            holder.ivCoursrImg.setOnClickListener(new View.OnClickListener(){
    ...
    protected class ViewHolder extends RecyclerView.ViewHolder {
        private ImageView ivCoursrImg;
        private TextView tvCourseImgTitle;
        private TextView tvCourseTitle;

        public ViewHolder(View view) {
            super(view);
            ivCoursrImg = (ImageView) view.findViewById(R.id.iv_coursr_img);
